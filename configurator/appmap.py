...
command_1_parameters = "Use -p|--project-name PROJECTNAME to initialize a project with a README.md, the appmap skeleton, a useful pyproject.toml and setup.py as templates. And that's it."
            ...
            "items": [
                {
                    "name": "-p|--project-name",
                    "type": "string",
                    "value": "Create a new project named 'project-name' using template_py's script repo template"
                }
            ]
        })
    ]
...
COMMAND_1_INPUTS = OrderedDict({
    ...
    "items": [
        OrderedDict({
            "name": "input-file-1",
            "type": "string",
            "value": "an input file to read/parse"
        })
    ],
...
COMMAND_1_STEPS = OrderedDict({
    ...
    "items": [
        OrderedDict({
            "name": "step1",
            "type": "string",
            "value": "performs step 1 in the programs step list."
        }),
        OrderedDict({
            "name": "step2",
            "type": "string",
            "value": "does something distinct from step 1, possibly N times, over data structure A, using Z filtering strategy, or something to this effect."
        })
    ]
})
...
command_2_description = "create a new project from template_py!"
command_2_description_long = ""

command_2_parameters = "Use -p|--project-name PROJECTNAME to initialize a project with a README.md, the appmap skeleton, a useful pyproject.toml and setup.py as templates. And that's it."
